...
class Evento(models.Model):
    ...
    presentaciones = models.CharField(max_length=2, choices=PRESENTACIONES)
    suscripciones = models.CharField(max_length=2, choices=SUSCRIPCIONES)
    publicar = models.CharField(max_length=2, choices=PUBLICAR)

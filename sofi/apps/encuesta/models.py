...
class Encuesta(models.Model):
    ...
    item3 = models.IntegerField(verbose_name="1.3 Los contenidos expuestos constituyen como herramienta de reforzamiento de la reflexión sobre la temática del Conocimiento Libre y Licenciamiento en América Latina", choices=MSPN)
    ...
    item5 = models.IntegerField(verbose_name="2.2 Considera suficientes los medios empleados para promover la interacción entre los participantes", choices=MSPN)
    ...
    item14 = models.IntegerField(verbose_name="5 Calificaría usted el desarrollo general del evento como un accionar colaborativo y cooperativo que ha generado insumos a la construcción de la idea del Conocimiento como Bien Público", choices=MSPN)

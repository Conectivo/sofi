...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(os.path.dirname(__file__), 'sofi.db'),                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'ujeequkwf!1t87g(mrj0$f53y@r!5w&a0219^bky=@2_=l%csy'
